...
from .processors.animation import AnimationProcessor
...
class MediaProcessor:
    ...
    def _init_processors(self) -> List:
        ...
        return [
            ...
            AnimationProcessor(self.user_storage, self.openai_client),
            DocumentProcessor(self.user_storage, self.openai_client),
    ...
    async def process_message(
        ...
        *,
        ...
        try:
            ...
            if vision_prompt:
                file_info["vision_prompt"] = vision_prompt
