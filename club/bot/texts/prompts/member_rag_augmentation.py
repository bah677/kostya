...
MEMBER_RAG_RULES = (
    ...
    "- Ссылку на материал давай ТОЛЬКО из поля «публичная ссылка» фрагмента (клубная группа t.me/c/3882558802/…).",
    "- Никогда не отправляй ссылки на закрытые учебные чаты и любые t.me/c/… кроме клубной группы.",
