...
CLUB_FRESH_INVITE_ACK_HTML = (
    "<b>Отправила новую ссылку для входа в клуб</b> — "
    "отдельным сообщением чуть ниже.\n\n"
    "Старые кнопки «Вступить в клуб» в истории чата больше не действуют."
)
...
def fresh_invite_html(*, inside_block: str, invite_footer: str) -> str:
    return (
        "🔗 <b>Новая ссылка для входа в клуб</b>\n\n"
        "Предыдущие приглашения мы отозвали — нажимайте только кнопку ниже.\n\n"
        f"{inside_block}\n\n"
        f"{invite_footer}"
    )
...
def admin_gift_invite_html(
    *, expires_str: str, inside_block: str, invite_footer: str
    ...
    return (
        ...
        f"Мы предоставили вам доступ в закрытый клуб <b>«Любящие Бога»</b> "
