...
from bot.texts.prompts.media import (
...
class OpenAIClient:
    ...
    async def describe_image(
        ...
        try:
            if prompt is None:
                prompt = VISION_DESCRIBE_IMAGE_DEFAULT
    ...
    # =====================================================
    # ТЕКСТ ПО ПРОМПТУ (шаблонные рассылки и пр.)
    # =====================================================
    ...
    async def complete_text_prompt(
        ...
        *,
        ...
        max_tokens: int = 2048,
        request_kind: str = "mailing_template_prompt",
    ) -> Optional[str]:
